...
public class PanelAsignatura extends JPanel {
	...
	public String getNombre(){
		if(this.asignaturas.getSelection() == null){
			...
			if(this.panelProf != null){
				return this.panelProf.getVentana().getSistema().getAsignatura(this.asignaturas.getSelection().getActionCommand()).getNombre();
			}else{
				return this.panelAlum.getVentana().getSistema().getAlumnoLog().getAsignatura(this.asignaturas.getSelection().getActionCommand()).getNombre();
			}
	...
	public void actualizarTemas(){
		...
		if(this.panelProf != null){
			...
			ControladorAccederContenido cont = new ControladorAccederContenido(this.panelProf.getVentana(),this);
			...
			ControladorAccederContenido cont = new ControladorAccederContenido(this.panelAlum.getVentana(),this);
			this.setControlador(cont);
			this.add(acceder);
